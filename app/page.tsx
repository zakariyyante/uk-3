...
export default async function Home({ searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#07080f] felt-texture">
      ...
      <section className="relative container mx-auto px-4 pt-8 pb-6 sm:pt-14 sm:pb-8 lg:pt-16 lg:pb-10 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-10 left-10 text-6xl sm:text-8xl opacity-[0.03] text-amber-400 rotate-12 select-none">♠</div>
          <div className="absolute top-20 right-16 text-5xl sm:text-7xl opacity-[0.03] text-red-400 -rotate-12 select-none">♥</div>
          <div className="absolute bottom-10 left-1/4 text-5xl sm:text-7xl opacity-[0.03] text-amber-400 rotate-6 select-none">♦</div>
          <div className="absolute bottom-5 right-1/4 text-6xl sm:text-8xl opacity-[0.03] text-red-400 -rotate-6 select-none">♣</div>
        </div>

        <div className="relative mx-auto max-w-4xl">
          <div className="inline-block mb-5 px-5 py-2 rounded-full bg-gradient-to-r from-amber-500/10 to-amber-600/10 border border-amber-500/20">
            <span className="text-xs sm:text-sm font-bold text-amber-400 uppercase tracking-wider">UK&apos;s Premier Casino Guide 2026</span>
          </div>
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white mb-5 leading-tight">
            Find the <span className="gold-text">Best Casinos</span> in the UK
          </h1>
          <p className="text-base sm:text-lg text-amber-100/50 mb-8 max-w-2xl mx-auto">
            Hand-picked platforms with exclusive bonuses, fast payouts, and top-tier gaming experiences
          </p>
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            <div className="flex items-center gap-2.5 bg-[#0f1120] rounded-full px-5 py-2.5 border border-amber-500/15">
              <span className="text-amber-400 text-lg">♠</span>
              <span className="text-amber-100/70 text-sm font-semibold">UKGC Licensed</span>
            </div>
            <div className="flex items-center gap-2.5 bg-[#0f1120] rounded-full px-5 py-2.5 border border-amber-500/15">
              <span className="text-amber-400 text-lg">★</span>
              <span className="text-amber-100/70 text-sm font-semibold">Expert Rated</span>
            </div>
            <div className="flex items-center gap-2.5 bg-[#0f1120] rounded-full px-5 py-2.5 border border-amber-500/15">
              <span className="text-amber-400 text-lg">♦</span>
              <span className="text-amber-100/70 text-sm font-semibold">Instant Withdrawals</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="casinos" className="container mx-auto px-4 pb-16">
        <div className="mb-3 sm:mb-5 lg:mb-8 text-center">
          ...
          <p className="text-sm sm:text-base text-amber-100/40">Updated weekly based on payout speed and player support.</p>
        </div>
        ...
        <div className="mt-8 sm:mt-12 lg:mt-16 bg-amber-500/5 border border-amber-500/15 rounded-2xl p-3 sm:p-4 lg:p-6 max-w-6xl mx-auto">
      ...
      {/* About Section */}
      <section id="about" className="bg-[#0a0c18] py-8 sm:py-12 lg:py-16 border-y border-amber-500/10">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="casino-card-bg rounded-2xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8 border border-amber-500/15">
            <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-amber-100 mb-3 sm:mb-4">
              Why Trust Our Reviews?
            </h4>
            <p className="text-amber-100/50 mb-3 sm:mb-4 text-sm sm:text-base leading-relaxed">
            ...
            <ul className="space-y-2.5 text-amber-100/50 text-sm sm:text-base">
          ...
          <div id="guide" className="bg-[#0d0f1e] rounded-2xl p-4 sm:p-6 lg:p-8 border border-amber-500/10 shadow-lg">
            <h4 className="text-lg sm:text-xl lg:text-2xl font-bold gold-text mb-3 sm:mb-4">
              Responsible Gambling
            </h4>
            <p className="text-amber-100/60 text-sm sm:text-base leading-relaxed mb-3 sm:mb-4">
              We are committed to promoting responsible gambling. If you or someone you know 
              has a gambling problem, please seek help:
            </p>
            <ul className="space-y-2 text-amber-100/60 text-sm sm:text-base">
              <li>• <strong className="text-amber-200/80">BeGambleAware:</strong> Visit{' '}
                <a href="https://www.begambleaware.org" className="text-amber-400 hover:text-amber-300 underline decoration-amber-400/30 underline-offset-2">
                  begambleaware.org
                </a>
              </li>
              <li>• <strong className="text-amber-200/80">GamCare:</strong> Call 0808 8020 133 or visit{' '}
                <a href="https://www.gamcare.org.uk" className="text-amber-400 hover:text-amber-300 underline decoration-amber-400/30 underline-offset-2">
                  gamcare.org.uk
                </a>
              </li>
              <li>• <strong className="text-amber-200/80">National Gambling Helpline:</strong> 0808 8020 133</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer id="contact" className="bg-[#050610] border-t border-amber-500/10 py-6 sm:py-8 lg:py-12">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8 mb-6 sm:mb-8">
            <div>
              <h5 className="text-amber-200/80 font-semibold mb-2 sm:mb-3 text-sm sm:text-base">Quick Links</h5>
              <ul className="space-y-1 sm:space-y-2 text-amber-100/40 text-xs sm:text-sm">
                <li><a href="#" className="hover:text-amber-400 transition-colors">Home</a></li>
                <li><a href="#casinos" className="hover:text-amber-400 transition-colors">Casinos</a></li>
              </ul>
            </div>
            <div>
              <h5 className="text-amber-200/80 font-semibold mb-2 sm:mb-3 text-sm sm:text-base">Legal</h5>
              <ul className="space-y-1 sm:space-y-2 text-amber-100/40 text-xs sm:text-sm">
            ...
            <div className="col-span-2">
              <h5 className="text-amber-200/80 font-semibold mb-2 sm:mb-3 text-sm sm:text-base">Disclaimer</h5>
              <p className="text-amber-100/40 text-xs sm:text-sm leading-relaxed">
          ...
          <div className="mt-6 sm:mt-10 flex flex-col items-center gap-4">
            <p className="text-amber-200/50 text-xs sm:text-sm uppercase tracking-widest font-semibold">
              Responsible Gambling
            </p>
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8">
              <div className="bg-amber-500/5 rounded-xl px-3 py-2 border border-amber-500/15">
                <svg width="48" height="48" viewBox="0 0 48 48" aria-label="18+ icon" role="img" className="w-10 h-10">
                  <circle cx="24" cy="24" r="23" fill="#d4a843" />
                  <text x="24" y="28" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="bold" fill="#07080f">
                    18+
                  </text>
                </svg>
              </div>
              <a 
                ...
                className="bg-amber-500/5 rounded-xl px-4 py-3 border border-amber-500/15 hover:border-amber-400/40 transition-colors"
                aria-label="Visit GamStop"
              >
                <svg width="180" height="60" viewBox="0 0 180 60" role="img" aria-label="GAMSTOP">
                  <rect x="1" y="1" width="178" height="58" rx="10" fill="none" stroke="rgba(212,168,67,0.15)" />
                  <rect x="10" y="10" width="70" height="30" rx="6" fill="#d4a843" />
                  <rect x="80" y="10" width="90" height="30" rx="6" fill="#0f1120" />
                  <text x="45" y="31" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="800" fill="#07080f">
                    GAM
                  </text>
                  <text x="125" y="31" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="800" fill="#d4a843">
                    STOP
                  </text>
                  <text x="90" y="48" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="12" fontWeight="700" fill="#d4a843">
                    ONLINE
                  </text>
                </svg>
              </a>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="220" height="56" viewBox="0 0 220 56" role="img" aria-label="GamCare">
                  <defs>
                    <linearGradient id="gc" x1="0%" y1="0%" x2="100%" y2="100%">
                      ...
                      <stop offset="60%" stopColor="#f0d078"/>
                      <stop offset="100%" stopColor="#d4a843"/>
                    </linearGradient>
                  </defs>
                  <rect x="1" y="1" width="218" height="54" rx="12" fill="none" stroke="rgba(212,168,67,0.15)"/>
                  ...
                  <text x="58" y="35" fontFamily="ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial" fontSize="22" fontWeight="800" fill="#d4a843">
                    GamCare
                  </text>
                </svg>
              </a>
          ...
          <div className="border-t border-amber-500/10 pt-4 sm:pt-6 text-center mt-6">
            <p className="text-amber-100/30 text-xs sm:text-sm">
              &copy; 2026 uk10casinos.com. For educational purposes only. 18+ only. Please gamble responsibly.
            </p>
          </div>
        </div>
      </footer>
